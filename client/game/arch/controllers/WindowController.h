...
public:
    WindowController(int player_id, SdlWindow* window, const ScreenConfiguration& screen_configuration, const Matrix& matrix);

    explicit WindowController(int player_id, const Matrix& matrix);
