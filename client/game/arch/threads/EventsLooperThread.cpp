...
void EventsLooperThread::pushEvent(int client_event_type, int picturable_id, const Point& click_position, const Point& release_position) {
    output_messages.push(ClientEvent(this->player_id, client_event_type, picturable_id, click_position, release_position));
}
