...
public:
    ...
    Picturable(int player_id, int id, std::string name, int sprite_direction, int sprite_motion, bool selected, Point position, Point size, int health, int max_health, int porcentage);
